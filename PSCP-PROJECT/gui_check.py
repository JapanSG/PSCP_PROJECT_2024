...
def on_check_button_click():
    ...
    if strength == "very weak":
        ...
        check_button.configure(text=strength, fg_color="orange")
    elif strength == "good":
        check_button.configure(text=strength, fg_color="yellow")
    elif strength == "strong":
        check_button.configure(text=strength, fg_color="light green")
...
password_entry.place(y=583, x=385)
...
check_button.place(y=650, x=591, anchor="center")

...
class PasswordGeneratorApp:
    ...
    def easy(self):
        e = customtkinter.CTkButton(self.root,text="easy",font=H1,command=self.boxeasy)
        e.place(relx= 0.25, rely= 0.5, anchor=customtkinter.CENTER)

    def medium(self):
        m = customtkinter.CTkButton(self.root,text="medium",font=H1,command=self.boxmedium)
        m.place(relx= 0.5, rely= 0.5, anchor=customtkinter.CENTER)

    def hard(self):
        h = customtkinter.CTkButton(self.root,text="hard",font=H1,command=self.boxhard)
        h.place(relx= 0.75, rely= 0.5, anchor=customtkinter.CENTER)
